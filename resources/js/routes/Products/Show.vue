<template>
  <section class="text-gray-700 body-font overflow-hidden" v-if="product">
    <div class="container px-12 py-24 mx-au">
        <div class="lg:-w-3/5 mx-auto flex flex-wrap">
            <img alt="ecommerce placeholder" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="https://dummyimage.com/640x640">
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                ></p>
                <div class="flex mt-6 border-t-2 border-gray-200">
                    <span
