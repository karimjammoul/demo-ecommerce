    ...
    <div class="lg:w-2/3 w-full mx-auto mt-8">
            ...
            <div class="p-2 w-1/3">
                <div class="relative">
                    ...
                    <input 
                        ...
                        id="first_name"
                        name="first_name"
                        class="w-full bg-gray-100 rounded border border-gray-300 focus:border-indigo-500 focus:outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
        ...
        <div class="flex flex-wrap -mx-2 mt-4">
            <div class="p-2 w-full">
                <div class="relative">
                    <label for="card_element" class="leading-7 text-sm text-gray-600">Credit Card Information</label>
...
export default {
    ...
    async mounted() {
        ...
        this.cardElement = elements.create('card', {
            classes: {
                base: 'bg-gray-100 rounded border border-gray-300 focus:border-indigo-500 focus:outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out'
            }
        });
